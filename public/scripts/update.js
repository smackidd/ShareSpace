...
// function propertyGET(property){
//     var xhttp = new XMLHttpRequest();  
//   xhttp.open("POST", "http://localhost:3030/user_data", true);
//   xhttp.send(property);
// }
...
let buttonPush = ()=> {
    ...
    createButton.addEventListener('click', ()=>{
        ...
        // to the contents of the permanent array.
            ...
            console.log(propertyTemp);
            //propertyGET(propertyTemp);
    ...
    addButton.addEventListener('click', ()=>{
        ...
        if (isValid){
            if (deleteAdd == false){   // if you have deleted and then added a workspace, skip next step
                workspaceTemp = {
    ...
    submitButton.addEventListener('click', ()=>{
        ...
        //this passes the data accumulated from all workspaces and places it in to a form input for 
        //the server to GET in router/update.js
        document.getElementById('propertyholder').value = JSON.stringify(workspaces);
